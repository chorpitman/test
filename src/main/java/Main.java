...
//        System.out.println(s11);
        ...
        System.out.println(lat2cyr(s6));
        System.out.println(lat2cyr(s7));
        System.out.println(lat2cyr(s8));
        System.out.println(lat2cyr(s9));
        System.out.println(lat2cyr(s10));
        System.out.println(lat2cyr(s11));
        System.out.println(lat2cyr(s12));
        System.out.println(lat2cyr(s13));
        System.out.println(lat2cyr(s14));
        System.out.println(lat2cyr(s15));
        System.out.println(lat2cyr(s16));
